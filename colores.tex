...
\newcommand{\notag}[2]{\sethlcolor{cgus} \hl{#1} \todo[color=cgus]{#2}}
...
para hacer nuestras {A mí me salen las notas de todos dobles.} anotaciones. \notantares{Verás que risa luego al imprimir esto...}
 Hay que instalarlo de
\url{http://ctan.org/pkg/todonotes} y luego añadir una anotación aquí {¿Aquí? Pues aquí la añado.}
o donde sea que indique el color que vamos a elegir. En el manual (y     \notapedro{¡Vamos a probarlo!})
ahí más arriba en el fuente) explica cómo hacer una macro para cada {Nota hecha por un daltónico}
uno.
En un lugar de la Mancha \notagus{¿Seguro que era la Mancha?}

Vamos a elegir cada uno un color para trabajar con {\tt todonotes} {Colorin, colorado, esta nota se ha acabado.}
para hacer nuestras\notamaribel{A mí me salen las notas de todos dobles.} anotaciones. {Verás que risa luego al imprimir esto...}
 Hay que instalarlo de
\url{http://ctan.org/pkg/todonotes} y luego añadir una anotación aquí \notapaloma{¿Aquí? Pues aquí la añado.}
o donde sea que indique el color que vamos a elegir. En el manual (y {¡Vamos a probarlo!})
ahí más arriba en el fuente) explica cómo hacer una macro para cada   \notafergu{Nota hecha por un daltónico}
uno.
En un lugar de la Mancha{¿Seguro que era la Mancha?}...
...
\begin{itemize}
\item SIPESCA under Programa Operativo FEDER de Andalucía 2007-2013
\item TIN2011-28627-C04-02 awarded by the Spanish Ministry of Economy and Competitivity
\item SPIP2014-01437 (Proyecto PETRA, funded by Dirección General de Tráfico)
\item Este proyecto con nº de referencia: PRY142/14 ha sido financiado íntegramente por la Fundación Pública Andaluza Centro de Estudios Andaluces en la IX Convocatoria de Proyectos de Investigación. \notamaribel{Este proyecto tiene que ponerse esta frase tal y como está, en espaniol, por exigencias del contrato.}
\item PYR-2014-17 GENIL project, awarded by CEI-BIOTIC Granada. \notaantonio{Borrad los antiguos y poned el mío, hombre ya! :D}
\end{itemize} 



A mí las notas me destrozan el texto, sale todo descuadrado.
